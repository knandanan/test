...
def main():
    ...
    ## Onnx conversion 
    onnx_model_path = "./convert_test_model_128.onnx"
    ...
    import onnx
    print("==> Loading and checking exported model from '{}'".format(onnx_model_path))
    ...
    # del data_config['interpolation']
    # del data_config['mean']
    # del data_config['std']
    print(data_config)
